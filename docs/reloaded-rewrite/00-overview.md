...
| Substantive driving-spec chapters | Chapters 03 through 28, chapters 31 through 33, and chapters 35 through 54 (chapter 54 is DRAFT; see chapter 30 R1).                |
...
31 through 33, and chapters 35 through 54) MUST
...
3. Chapters 03 through 28 in numerical order, then chapters 31 through
  33, then chapters 35 through 54 (chapter 34 is read separately as
  item 6 below). Each chapter is self-contained and can be read
