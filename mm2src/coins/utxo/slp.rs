...
#[path = "slp/slp_token_ops.rs"]
mod slp_token_ops;

#[path = "slp/slp_swap_ops.rs"]
mod slp_swap_ops;

#[path = "slp/slp_coin_ops.rs"]
mod slp_coin_ops;
...
impl From<Error> for SpendHtlcError {
    fn from(err: Error) -> SpendHtlcError {
