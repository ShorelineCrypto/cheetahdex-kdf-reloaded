...
impl EthCoin {
    ...
    pub(crate) async fn validate_maker_payment_v2_impl(
        ...
        match self.coin_type {
            EthCoinType::Eth => {
                ...
                validate_eth_maker_payment_data(&decoded, &validation_args, function, tx.value)?;
            },
    ...
    /// Prepares data for EtomicSwapMakerV2 contract ethMakerPayment method
    ...
    /// Prepares data for EtomicSwapMakerV2 contract erc20MakerPayment method
    ...
    /// Prepares data for EtomicSwapMakerV2 contract refundMakerPaymentTimelock method
    ...
    /// Prepares data for EtomicSwapMakerV2 contract refundMakerPaymentSecret method
    ...
    /// Prepares data for EtomicSwapMakerV2 contract spendMakerPayment method
