// Portions of this file are adapted from `tokio-rusqlite`
// (https://github.com/programatik29/tokio-rusqlite), Copyright 2022 Eray Karatay,
// licensed under the MIT license. The full upstream MIT notice is reproduced in
// `LEGAL/THIRDPARTY-LICENSES`. See `docs/reloaded-rewrite/34-provenance-ledger.md`
