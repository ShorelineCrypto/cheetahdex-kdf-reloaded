...
use crate::standalone_coin::{
    InitStandaloneCoinActivationOps, InitStandaloneCoinTaskHandle, InitStandaloneCoinTaskManagerShared,
};
...
impl InitStandaloneCoinActivationOps for QtumCoin {
    ...
    async fn init_standalone_coin(
        ...
        let priv_key_policy = priv_key_build_policy(&ctx, &crypto_ctx, activation_request.priv_key_policy)?;
